...
def requerir_autenticacion():
    ...
    if not st.session_state["usuario_autenticado"]:
        ...
        with st.form("login_form"):
            ...
            username = st.text_input("Usuario", placeholder="Ingresa tu usuario...", help="Introduce tu nombre de usuario para acceder al sistema (ej. admin o operador)")
            password = st.text_input("Contraseña", type="password", placeholder="Ingresa tu contraseña...", help="Introduce tu contraseña de acceso")
            submit = st.form_submit_button("Ingresar", use_container_width=True, help="Haz clic para iniciar sesión y acceder al panel de control")
