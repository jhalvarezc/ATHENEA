...
def requerir_autenticacion():
    ...
    if not st.session_state["usuario_autenticado"]:
        ...
        with st.form("login_form"):
            ...
            username = st.text_input("Usuario", placeholder="Ingresa tu usuario...", help="Ingresa tu nombre de usuario asignado para acceder al sistema.")
            password = st.text_input("Contraseña", type="password", placeholder="Ingresa tu contraseña...", help="Ingresa la contraseña asociada a tu cuenta.")
            submit = st.form_submit_button("Ingresar", use_container_width=True, help="Haz clic para verificar tus credenciales e iniciar sesión.")
